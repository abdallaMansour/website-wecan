...
<head>
  ...
  <title>Chat Screen with Connected Doctors and Patients</title>
  ...
  <div class="flex flex-col h-screen">
    ...
    <div class="flex flex-1 overflow-hidden">
      ...
      <div class="w-64 bg-white border-r border-gray-200 p-4 overflow-y-auto">
        <h3 class="text-xl font-semibold mb-4">Chat Rooms</h3>
            ...
            <div class="p-4 border-t bg-gray-100">
              <form id="chat-form" class="flex">
                <input
                  type="text"
                  id="message-input"
                  class="flex-1 border rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-[#e2f4fe] mr-[5px]"
