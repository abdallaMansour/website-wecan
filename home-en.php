...
<head>
  ...
  <title>Connected - Home Page</title>
  <link
    rel="stylesheet"
...
<body>
  <div class="flex w-full">
    ...
    <div class="container mt-5">
      <h1 class="mb-4 text-center">Connected</h1>
    ...
    $(document).ready(function() {
      ...
      function displayAttachments(attachments, listId, type) {
        ...
        attachments.forEach(function(attachment) {
          const statusClass =
            ...
            "status-approved";
          const statusText =
            attachment.pivot.status === "pending" ? "Pending" : "Approved";
          const item = `
          ...
          const row = `
              <tr>
                ...
                <td class="py-2 px-4 border-b">${
                  attachment.account_type === "patient" ? "Patient" : "Doctor"
                }</td>
      ...
      $("#attachmentForm").on("submit", function(e) {
        ...
        $.ajax({
          ...
          error: function(xhr) {
            alert("Error sending connection request: " + xhr.responseText);
          },
        });
      });
      ...
      $(document).on("click", ".approve-btn", function() {
        ...
        $.ajax({
          ...
          error: function(xhr) {
            alert("Error approving connection: " + xhr.responseText);
          },
        });
      });
      ...
      $(document).on("click", ".cancel-btn", function() {
        ...
        if (
          confirm(
            `Are you sure you want to cancel the connection with ${email}?`
          )
        ) {
          // Implement cancellation logic here
          alert(`Connection cancelled with ${email} (${type})`);
          fetchAttachments();
        }
      });
