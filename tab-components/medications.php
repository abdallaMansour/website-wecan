...
<div id="medicationsTab">
  <h2 class="text-xl font-semibold mb-4">الأدوية</h2>
    ...
    <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-right overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4" id="modalTitle">إضافة دواء جديد</h3>
                <div class="space-y-4">
                    <div>
                        <label for="drugName" class="block text-sm font-medium text-gray-700">اسم الدواء</label>
                    ...
                    <div>
                        <label for="frequency" class="block text-sm font-medium text-gray-700">عدد مرات التناول</label>
                    ...
                    <div>
                        <label for="frequencyPer" class="block text-sm font-medium text-gray-700">لكل</label>
                    ...
                    <div>
                        <label for="instructions" class="block text-sm font-medium text-gray-700">التعليمات</label>
                    ...
                    <div>
                        <label for="duration" class="block text-sm font-medium text-gray-700">المدة (بالأيام)</label>
                    ...
                    <div>
                        <label for="drugImage" class="block text-sm font-medium text-gray-700">صورة الدواء</label>
                    ...
                    <div class="flex items-center">
                        ...
                        <label for="show" class="mr-2 block text-sm text-gray-900">إظهار للمريض</label>
                    </div>
                </div>
            </div>
...
<script>
  function initMedicationsTab() {
          ...
          <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
            ${
              !isHospital
                ...
                : `<button class="text-indigo-600 hover:text-indigo-900 edit-medication" data-id="${medication.id}">تعديل</button>
               <button class="ml-2 text-red-600 hover:text-red-900 delete-medication" data-id="${medication.id}">حذف</button>`
            }
    ...
    $("#addMedicationBtn").on("click", function () {
      ...
      $("#modalTitle").text("إضافة دواء جديد");
      clearModalFields();
    });
    ...
    $("#medicationsTableBody").on("click", ".view-image", function () {
      ...
      if (imageUrl) {
        ...
        alert("لا توجد صورة متاحة لهذا الدواء.");
      }
    });
    ...
    $("#saveMedicationBtn").on("click", function () {
      ...
      if ($("#modalTitle").text() === "إضافة دواء جديد") {
