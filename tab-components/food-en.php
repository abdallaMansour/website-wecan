...
<style>
  ...
  <div id="foodTab">
    <h2 class="text-xl font-semibold mb-4">Food</h2>
            ...
            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
              ...
              <div class="mt-2">
                ...
                <textarea
                  ...
                  rows="3"
                ></textarea>
                <label for="attachments" class="block mt-1">Attachments</label>
                <input
                  type="file"
                  id="attachments"
                  multiple
                ...
                <div class="mt-1">
                  ...
                  <label for="show">Show to Patient</label>
                </div>
              </div>
            </div>
          </div>
  ...
  <script>
    function initFoodTab() {
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                ${
                  !isHospital
                    ...
                    : `<button class="text-indigo-600 hover:text-indigo-900 edit-food" data-id="${food.id}">Edit</button>
                       <button class="ml-2 text-red-600 hover:text-red-900 delete-food" data-id="${food.id}">Delete</button>`
                }
              </td>
            </tr>
          `;
      ...
      $("#saveFoodBtn").on("click", function () {
        ...
        if ($("#modalTitle").text() === "Add New Food") {
          addFood(formData);
        } else {
          updateFood(formData);
        }
